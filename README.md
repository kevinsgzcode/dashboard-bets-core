...
- **Real-time ROI Calculation:** dynamic algorithms that track Initial Bankroll vs. Current Profit/Loss to visualize financial health.
- **Odds Conversion:** Automatic parsing and conversion between **American** and **Decimal** odds systems.
- **Interactive Charts:** Custom-built data visualization to track performance trends over time.

### 🏈 Automated Data Pipeline
- **ESPN API Integration:** Engineered a backend service that fetches NFL game results automatically.This eliminates manual data entry and ensures 100% accuracy for "Win/Loss" result updates.

### 🔐 Security & Persistence
- **Custom Auth System:** Secure user registration and login using **bcrypt** for password hashing and session management strategies.
